  ...
  useEffect(() => {
    ...
    const initializePage = async () => {
      try {
        ...
        announce('Discovery Hook page loaded successfully. Use tab to navigate or activate screen reader.', 'polite');

      } catch (error) {
        console.error('[Discovery Hook] Initialization failed:', error);
        
        // Announce error to screen readers
        announce('Page loading encountered an error. Some features may not work properly.', 'assertive');
      ...
      >
        ...
        >
          <div className="bg-white rounded-xl p-8 shadow-xl text-center w-[350px] max-w-[90vw]">
            <h2 id="login-modal-title" className="text-xl font-bold mb-2 text-canai-dark">Login Required</h2>
        ...
        >
          <div className="bg-white rounded-xl p-8 shadow-xl text-center w-[350px] max-w-[90vw]">
            <h2 id="error-modal-title" className="text-xl font-bold mb-2 text-canai-red">Something Went Wrong</h2>

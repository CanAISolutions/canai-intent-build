...
import { trackIntentMirrorLoaded, trackSupportRequested, POSTHOG_EVENTS } from './analytics';
...
export const triggerIntentMirrorWorkflow = async (businessData: Record<string, any>) => {
...
export const generateGPT4oIntentMirror = async (businessData: Record<string, any>) => {
  try {
    const correlationId = generateCorrelationId();

...
const TrustIndicators = () => {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(132deg, rgba(18,41,74,0.82) 60%, rgba(27,49,76,0.83) 100%)",
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(120deg, rgba(28,64,120,0.11) 60%,rgba(54,209,254,0.12) 100%)",
      ...
      <div className="w-full max-w-5xl px-4 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-5 relative z-10">
        ...
        <div className="bg-white/5 bg-clip-padding backdrop-blur-lg rounded-2xl p-8 text-center space-y-4 flex flex-col justify-center items-center md:items-start md:text-left shadow-strong border border-white/10 hover:shadow-[0_0_24px_#36d1fe44] transition-all">
            ...
            {[...Array(5)].map((_, i) => (
              <Star
                ...
                className={`text-yellow-300 fill-current transition-all duration-300 will-change-transform 
                  ${starVisible[i] ? "scale-110 opacity-100 animate-glow-pop" : "scale-75 opacity-45"}`}
                size={25}
          ...
          <blockquote
            ...
            style={{
              ...
              color: "#F7FAFF",
              textShadow:
                "0 2px 22px #36d1fe99,0 1px 10px #000b,0 0 4px #fff3"
            }}
        ...
        <div className="bg-white/5 bg-clip-padding backdrop-blur-lg rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-strong border border-white/10 hover:shadow-[0_0_24px_#36d1fe44] transition-all md:border-x md:border-canai-primary/10">
          <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#205680] to-[#36d1fe99] rounded-full mb-3 mx-auto shadow-[0_0_18px_#36d1feb7] animate-glow-pop" style={{ animationDelay: "500ms" }}>
            <Users className="text-canai-cyan" size={28} style={{ filter: "drop-shadow(0 0 9px #fff8), drop-shadow(0 0 6px #36d1fe88)" }} />
          </div>
          <div
            ...
            style={{
              fontWeight: 900,
              color: "#00F0FF",
              textShadow: "0 4px 28px #36d1fecc, 0 0 8px #00cfff99, 0 1px 2px #fff"
            }}
        ...
        <div className="bg-white/5 bg-clip-padding backdrop-blur-lg rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-strong border border-white/10 hover:shadow-[0_0_24px_#36d1fe44] transition-all">
          <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#205680] to-[#36d1fe99] rounded-full mb-3 mx-auto shadow-[0_0_18px_#36d1feb7] animate-glow-pop" style={{ animationDelay: "800ms" }}>
            <Award className="text-canai-cyan" size={28} style={{ filter: "drop-shadow(0 0 9px #fff8), drop-shadow(0 0 6px #36d1fe88)" }} />
          </div>
          <div
            className="text-5xl font-extrabold text-canai-cyan font-manrope animate-countup-glow"
            style={{
          ...
          <div className="w-28 h-3 rounded-full bg-canai-primary/35 border border-canai-primary/60 relative overflow-hidden shadow-strong">
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 16px #36d1fecc, 0 0 11px #36d1febb, 0 2px 10px #00CFFFcc",

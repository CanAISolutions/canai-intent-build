  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" id="comparison-container">
      ...
      <div className="flex flex-col h-full">
        <div className="bg-gradient-to-br from-[#1E314F] to-[#2A4A6B] rounded-xl border-2 border-[#00CFFF] shadow-xl flex-1 flex flex-col">
          ...
          <div className="p-6 flex-1">
            <div 
              className="text-base leading-relaxed text-canai-light prose prose-invert max-w-none"
      ...
      {/* Generic Output */}
      <div className="flex flex-col h-full">
        <div className="bg-gradient-to-br from-[#22335C] to-[#334567] rounded-xl border-2 border-[#666] shadow-xl flex-1 flex flex-col">
          ...
          <div className="p-6 flex-1">
            <div 
              className="text-base leading-relaxed text-gray-300 prose prose-invert max-w-none"
              style={{ whiteSpace: 'pre-wrap' }}
            >

      ...
      <form onSubmit={onSubmit} className="space-y-8">
        <div>
          <h3 className="flex items-center text-2xl font-bold font-playfair text-canai-light mb-3" id="feedback-heading">
            ...
            <span className="bg-gradient-to-r from-[#193c65] via-[#00B2E3]/40 to-transparent px-3 py-1 rounded-xl animate-fade-in">Which output feels more like you?</span>
          </h3>
          ...
          >
            <div className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-[#00CFFF]/10 to-transparent border border-[#00CFFF]/30 p-6 focus-within:border-[#00CFFF] focus-within:ring-2 focus-within:ring-[#00CFFF]/15">
              <div className="flex items-center space-x-4">
                ...
                >
                  <SparkleIcon className="scale-90" />CanAI Output
        ...
        <p id="submit-help" className="text-sm text-canai-light opacity-60 text-center">

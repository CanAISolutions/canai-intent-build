...
const standardButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium font-manrope transition-all duration-300 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 active:scale-95 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary: 
          "bg-gradient-to-r from-[#36d1fe] to-[#00b8e6] text-white shadow-[0_0_30px_rgba(54,209,254,0.5)] " +
          "hover:from-[#4ae3ff] hover:to-[#36d1fe] hover:shadow-[0_0_40px_rgba(54,209,254,0.7)] hover:scale-105 " +
          "focus-visible:ring-[#36d1fe]/50 active:scale-100",
        secondary:
          "bg-[rgba(25,60,101,0.7)] border-2 border-[#36d1fe] text-white backdrop-blur-md " +
          "hover:bg-[rgba(54,209,254,0.1)] hover:border-[#4ae3ff] hover:scale-105 " +
        ...
        ghost:
          ...
          "hover:bg-[rgba(54,209,254,0.1)] hover:text-white " +
          "focus-visible:ring-[#36d1fe]/50",
        destructive:

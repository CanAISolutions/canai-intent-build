...
const enhancedButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#36d1fe] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0F1C] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98] active:translate-y-0 touch-manipulation min-h-[44px] min-w-[44px]",
  {
    variants: {
      variant: {
        default: "bg-[#36d1fe] text-white hover:bg-[#2bc4f0] shadow-[0_4px_14px_rgba(54,209,254,0.4)] hover:shadow-[0_8px_25px_rgba(54,209,254,0.6)] hover:scale-[1.02] hover:-translate-y-0.5",
        destructive: "bg-red-500 text-white hover:bg-red-600 shadow-lg hover:shadow-xl hover:scale-[1.02] hover:-translate-y-0.5",
        outline: "border-2 border-[#36d1fe] text-[#36d1fe] bg-transparent hover:bg-[#36d1fe]/10 hover:scale-[1.02] hover:-translate-y-0.5 hover:shadow-lg",
        secondary: "bg-[#1e314f] text-white border border-[#36d1fe]/30 hover:bg-[#275084] hover:scale-[1.02] hover:-translate-y-0.5 hover:shadow-lg",

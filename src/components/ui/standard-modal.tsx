...
interface StandardModalContentProps extends React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> {
...
>(({ className, children, size = "md", variant = "default", ...props }, ref) => {
  ...
  const variantClasses = {
    default: "bg-gradient-to-br from-[#193c65] via-[#1e4a73] to-[#12294a] border-2 border-[#36d1fe] shadow-[0_0_60px_rgba(54,209,254,0.4)]",
    glass: "bg-[rgba(25,60,101,0.9)] backdrop-blur-xl border-2 border-[rgba(54,209,254,0.3)] shadow-[0_0_40px_rgba(54,209,254,0.3)]",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-2xl font-bold text-white font-manrope tracking-tight drop-shadow-lg", className)}
    {...props}
  />
));

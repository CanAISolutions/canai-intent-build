      ...
      <div className="relative">
        ...
        <StandardCard 
          ...
          className={`
            ...
            ${animationPhase >= 2 ? 'scale-100 opacity-100 translate-y-0' : 'scale-90 opacity-0 translate-y-4'}
          `}
        >
          ...
          <BodyText className="mb-6">
            Thank you for helping us improve CanAI. Your insights make a difference.
          </BodyText>
          ...
          {animationPhase >= 3 && (
            <div className="absolute -bottom-2 -right-2 animate-fade-in" style={{ animationDelay: '200ms' }}>

...
import { CheckCircle, TrendingUp, Clock, Shield, Award, Users } from "lucide-react";
...
const PsychologicalTrustIndicators = () => {
  ...
  const trustMetrics = [
    { icon: TrendingUp, label: "Success Rate", value: "78%", detail: "of plans get funded" },
    { icon: Clock, label: "Avg. Delivery", value: "18hrs", detail: "typical turnaround" },
    { icon: Users, label: "Happy Founders", value: "500+", detail: "funded this year" },
    { icon: Award, label: "Funding Raised", value: "$50M+", detail: "by our users" }
  ];
  ...
  return (
    <section className="w-full py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        `}>
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#193c65]/80 to-[#1e4a73]/80 
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            { icon: CheckCircle, text: "Venture-Backed", subtext: "By top VCs" },
            { icon: Shield, text: "SOC 2 Compliant", subtext: "Enterprise security" },
            { icon: Award, text: "Industry Awards", subtext: "AI Excellence 2024" },
            ...
            >
              ...
              <div className="text-sm font-semibold text-white font-manrope">{item.text}</div>
              <div className="text-xs text-[#E6F6FF] opacity-70">{item.subtext}</div>
            </div>
          ))}
        </div>
        ...
        <div className={`
          ...
          ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}
        `}>
          <div className="bg-gradient-to-r from-[#193c65]/70 to-[#1e4a73]/70 
                         backdrop-blur-md rounded-2xl p-6 border border-[#36d1fe]/30
                         shadow-[0_0_25px_rgba(54,209,254,0.15)]">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#36d1fe] to-[#00b8e6] 
                             flex items-center justify-center text-white font-bold text-lg">
                S
              </div>
              <div className="flex-1 text-left">
                <p className="text-[#E6F6FF] italic mb-3 font-manrope leading-relaxed">
                  "CanAI's business plan helped us raise $2.5M in Series A. The emotional intelligence 
                  in their writing was exactly what investors wanted to see."
                </p>
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-white font-semibold font-playfair">Sarah Chen</div>
                    <div className="text-[#36d1fe] text-sm">CEO, TechFlow • $2.5M raised</div>
                  </div>

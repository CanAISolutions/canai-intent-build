...
import { Eye, DollarSign, Sparkles, Clock, ArrowRight, Star } from "lucide-react";
...
const EnhancedSecondaryCTAs: React.FC<EnhancedSecondaryCTAsProps> = ({
  ...
  return (
    <section className="flex justify-center w-full mt-8 mb-8 px-4 animate-fade-in" style={{ animationDelay: "1s" }}>
      <div className="max-w-4xl w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div
            className={`
              ...
              border-2 ${hoveredCard === 'pricing' ? 'border-[#36d1fe]' : 'border-[rgba(54,209,254,0.4)]'}
          ...
          >
            <div className="p-6 text-center">
              <div className="mb-4 relative">
                <DollarSign className={`w-8 h-8 text-[#36d1fe] mx-auto transition-transform duration-300 
                                       ${hoveredCard === 'pricing' ? 'scale-110 rotate-12' : ''}`} />
                <div className="absolute -top-2 -right-2 bg-green-500 text-white text-xs px-2 py-1 rounded-full">
                  Popular
                </div>
              </div>
              <div className="font-bold text-xl mb-2 text-white font-playfair">View Pricing</div>
          ...
          <div
            className={`
              group relative overflow-hidden rounded-2xl transition-all duration-300
              bg-gradient-to-br from-[#193c65]/80 to-[#1e4a73]/80 backdrop-blur-md
              border-2 ${hoveredCard === 'samples' ? 'border-[#36d1fe]' : 'border-[rgba(54,209,254,0.4)]'}
              hover:scale-105 hover:shadow-[0_0_40px_rgba(54,209,254,0.4)]
              cursor-pointer
            `}
          ...
          >
            <div className="p-6 text-center">
              <div className="mb-4 relative">
                <Eye className={`w-8 h-8 text-[#36d1fe] mx-auto transition-transform duration-300 
              ...
              <div className="font-bold text-xl mb-2 text-white font-playfair">See Examples</div>
              <div className="text-sm text-[#E6F6FF] opacity-80 mb-4 font-manrope">
          ...
          >
            <div className="p-6 text-center relative z-10">
              <div className="mb-4 relative">
                <Sparkles className={`w-8 h-8 text-[#0a1628] mx-auto transition-transform duration-300 
                                     ${hoveredCard === 'preview' ? 'scale-110 rotate-12' : ''}`} />
                <div className="absolute -top-2 -right-4 bg-red-500 text-white text-xs px-2 py-1 rounded-full animate-pulse">
                  FREE
                </div>
              </div>
              <div className="font-bold text-xl mb-2 text-[#0a1628] font-playfair">Try Free Spark</div>
        ...
        <div className="text-center mt-8">
          ...
          <div className="text-xs text-[#cce7fa] opacity-60">
            Trusted by 500+ founders • Featured in TechCrunch, Forbes • SOC 2 Compliant
          </div>
        </div>
      </div>
    </section>

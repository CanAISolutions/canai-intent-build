        ...
        <div className="space-y-6">
          ...
          <div className="bg-canai-blue-card/50 rounded-lg p-6">
            ...
            <p className="text-canai-light mb-4">
              We stand behind our work. If you're not completely satisfied with your CanAI deliverable, 
              we'll refund your full payment within 30 days of purchase.
            </p>
          </div>

          {/* Refund Process */}
          <div className="space-y-4">
            <h4 className="text-canai-card-title font-semibold">How to Request a Refund</h4>
            
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <Clock className="w-5 h-5 text-canai-primary mt-1" />
                <div>
                  <span className="text-canai-light font-medium">Within 30 Days:</span>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-canai-light font-medium">Fast Processing:</span>
                  <p className="text-canai-light-blue text-sm mt-1">

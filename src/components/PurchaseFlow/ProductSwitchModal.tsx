      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-canai-blue-card/50 rounded-lg p-4">
            <h3 className="text-canai-card-title font-semibold mb-2">Currently Selected:</h3>
            <div className="flex items-center justify-between">
              <div>
                <span className="text-canai-light font-medium">{currentProduct.name}</span>
                <p className="text-canai-light-blue text-sm">{currentProduct.description}</p>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-canai-light font-medium">{product.name}</span>
                      {product.highlighted && (
                    ...
                    <p className="text-canai-light-blue text-sm mb-2">{product.description}</p>
          ...
          <p className="text-xs text-canai-light-blue text-center opacity-80">
            Switching will update your checkout session with the new product pricing
          </p>
        </div>
      </DialogContent>
    </Dialog>

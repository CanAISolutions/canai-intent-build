...
describe("FeedbackPage", () => {
  ...
  test("renders main feedback form elements", () => {
    ...
    expect(screen.getByPlaceholderText(/business plan comparison/)).toBeInTheDocument();
  ...
  test("displays enhanced referral component", () => {
    ...
    expect(screen.getByText("Get $10 credit for each successful referral")).toBeInTheDocument();
